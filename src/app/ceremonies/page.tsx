...
import { Expand, Edit, ExternalLink, PlusCircle, CheckCircle, Eye, MousePointerClick, Users, Share2 } from 'lucide-react';
            ...
            <div className="container py-12 md:py-16 space-y-12">
                <div className="text-center">
                    <h1 className="text-4xl md:text-5xl font-headline bg-gradient-to-br from-white to-neutral-400 bg-clip-text text-transparent">
                        <EditableTitle tag="span" id="allCeremoniesPageTitle" initialValue={t('allCeremoniesPageTitle')} />
                    </h1>
                    <p className="mt-2 text-lg text-foreground/80 font-body">
                         <EditableTitle tag="span" id="allCeremoniesPageSubtitle" initialValue={t('allCeremoniesPageSubtitle')} />
                    </p>
                    {isAuthorized && (
